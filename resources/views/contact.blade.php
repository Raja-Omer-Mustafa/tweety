...
<body class="bg-gray-300" style="font-family:Roboto">
    <div class="w-full h-screen flex items-center justify-center">
        <form method="POST" action="/sendmail" class="w-full md:w-1/3 bg-white rounded-lg">
            ...
            <h2 class="text-3xl text-center text-gray-700 mb-4">Contact us</h2>
            @php
                $success = session()->get('success') ? session()->get('success') : ($success ?? null);
            @endphp
            <div class="px-12 pb-10">
                ...
                <button type="submit"
                    class="w-full py-2 rounded-full bg-green-600 text-gray-100  focus:outline-none">send mail</button>
        </form>
    </div>
</body>
